(function($, undefined) {
	...
	var datepicker = '<div class="ui-date"><div class="ui-date-container b"><div class="yui3-u-5-6 ui-date-select"><div class="yui3-u-1-2"><div class="yui3-u-4-5"><a href="#" onclick="return false;" hidefocus="true"><div class="ui-date-year"><div class="yui3-u-3-4 ui-date-text">2013</div><div class="yui3-u-1-4 ui-date-arrow"><div class="ui-date-arrow-blank"></div></div></div></a></div><div class="yui3-u-1-5"><span class="ui-date-text">年</span></div></div><div class="yui3-u-1-2"><div class="yui3-u-1-5"></div><div class="yui3-u-3-5"><a href="#" onclick="return false;" hidefocus="true"><div class="ui-date-month"><div class="yui3-u-2-3 ui-date-text">12</div><div class="yui3-u-1-3 ui-date-arrow"><div class="ui-date-arrow-blank"></div></div></div></a></div><div class="yui3-u-1-5"><span class="ui-date-text">月</span></div></div></div><div class="yui3-u-19-24 ui-date-year-options"><div><a href="#" onclick="return false;" hidefocus="true" class="ui-date-slideleft"><div class="ui-date-arrow"></div></a><a href="#" onclick="return false;" hidefocus="true" class="ui-date-slideright"><div class="ui-date-arrow"></div></a><a href="#" onclick="return false;" hidefocus="true" class="ui-date-slideup"><div class="ui-date-slideup-arrow"></div></a></div><div class="ui-date-year-option"></div></div><div class="yui3-u-19-24 ui-date-month-options"><div><a href="#" onclick="return false;" hidefocus="true" class="ui-date-slideup"><div class="ui-date-slideup-arrow"></div></a></div><div class="ui-date-month-option"></div></div><div class="yui3-u-11-12 ui-date-datatime"><div class="nor"><span>周一</span><span>周二</span><span>周三</span><span>周四</span><span>周五</span><span>周六</span><span>周日</span></div><div></div></div></div></div>',
		//定义闰年和平年每月的总天数
	...
	$.fn.datepicker = function(options) {
		...
		$(document).on('mousedown', function(evt) {
			...
			!closest($target, $.datepicker.$input) && 
				!closest($target, $.datepicker.$el) && 
				!closest($target, $.datepicker.options.handler) &&
				$.datepicker.hide();
		});
